...
[Download tài liệu buổi 1](https://github.com/Zenfection/zenctu/raw/main/docs/cosonganh/CT112-Mang_may_tinh/Thuchanh/file/3.pdf)
...
- `switch1` chỉ học được địa chỉ của máy `pc2`

- `switch2` chỉ học được địa chỉ của máy `pc2`
