...
[Download tài liệu buổi 1](https://github.com/Zenfection/zenctu/raw/main/docs/cosonganh/CT112-Mang_may_tinh/Thuchanh/file/2.pdf)
...
- Toàn bộ khung số `3` có kích thước là `98 byte`
...
> <img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/09/28-21-03-52-Screen%20Shot%202021-09-28%20at%2021.03.46.png">
  ...
  1. Địa chỉ `MAC` của máy gửi dữ liệu là `f2:0a:34:63:fb:bc`, đây là địa chỉ của `pc2`
  
  2. Địa chỉ `MAC` của máy nhận dữ liệu là `ba:96:5f:5b:b5:fd`, đây là địa chỉ `MAC` của `router1`
