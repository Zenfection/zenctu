...
::: tip 💡 THIẾT LẬP MẠNG TRONG VITURALBOX

- **Bước 1:** Vào `Network` trong `VirualBox` tạo mới mạng `NAT` như sau : 
  
  <img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/09/20-14-23-16-Screen%20Shot%202021-09-20%20at%2014.22.49.png" width="500">

- **Bước 2:** Vào `Setting` trong máy ảo `Ubuntu`, vào `Network` và đổi thảnh `Natnetwork` như sau:

  <img src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/09/20-14-23-18-Screen%20Shot%202021-09-19%20at%2015.10.52.png" width="500">
:::
...
Sử dụng lại mô hình cuả [Bài tập 1](/cosonganh/CT112-Mang_may_tinh/Thuchanh/1.md#_2-bai-tap-1)
