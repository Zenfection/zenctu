...
export default defineUserConfig<DefaultThemeOptions>({
  ...
  locales: {
    '/': {
      ...
      description: 'Môi trường học tập lý tưởng cho sinh viên Công Nghệ Thông Tin'
    },
  },
  ...
  markdown: {importCode: {handleImportPath: (str) =>str.replace(/^@vuepress/,path.resolve(__dirname, '../../packages/@vuepress')),},},

  plugins: [
    // ['@vuepress/plugin-debug'],
    ['@vuepress/plugin-docsearch',{appId: '3CJDV2AFXL',apiKey: '4f7f93d347463109c3b6fd21d3ac2424',indexName: 'ctuvn',placeholder:"Tìm Kiếm..."},],
